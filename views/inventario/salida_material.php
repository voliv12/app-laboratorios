...
<div>
    	<!--div style="float: left; margin: 0 100px 0 0; ">
    		<h4>Salida de Material</h3>
    	</div>
    	<div style="padding: .3em;">
    		<ul class="nav nav-pills">
				<li role="presentation"><a href="catalogos/materiales/control">Mis Materiales</a></li>
				<li role="presentation"><a href="inventario/inventario_material/entrada"><i class="icon-arrow-down"></i>Entrada de Material</a></li>
			</ul>
    	</div-->
    	<ul class="nav nav-pills" role="tablist">
            <li role="presentation"><a href="catalogos/materiales/control">Mis Materiales</a></li>
            <li role="presentation"><a href="inventario/inventario_material/entrada">Entrada de Material</a></li>
            <li role="presentation" class="active"><a href="inventario/inventario_material/salida">Salida de Material</a></li>
